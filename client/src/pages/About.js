    ...
    return (
        <div id="aboutPages">
            ...
            <div id="aboutText">
                ...
                <p>I was born and raised in the north suburbs of Chicago. Graduated from Depaul Univeristy in 2019 with a major in communications concentrating on media production and a minor in film. Though I've stayed close to home in the city I love, I also have a passion for travel and exploring new places. This, in part, is what led me to study abroad at Monash University in Melbourne, Australia.</p>
                <p>After I graduated I worked as a content producer and then as an operations accosiate for a local logistics company called Schlep in Chicago. Feeling creativley unfulfilled, I decided to make a career change into web development. I completed Northwestern University's full stack web development program and have been working as free lance web developer since the beginign of the year. Check out the portfolio page to view some of my projects! </p>
                </div>
            </div>
